...
class InstructionResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                //
                Select::make('category_instruction_id')
                    ->label('Category Instruction')->options(CategoryInstruction::all()->pluck('name', 'id'))
                    ->columnSpanFull(),
                TextInput::make('content')->columnSpanFull()->hintColor('white')
            ]);
    }
